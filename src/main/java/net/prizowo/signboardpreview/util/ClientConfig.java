...
public class ClientConfig {
    ...
    public static final ModConfigSpec.IntValue BACKGROUND_COLOR;
    ...
    static {
        ...
        BACKGROUND_COLOR = builder
            .comment("文本背景颜色 (ARGB格式，默认为半透明黑色: -2147483648) | Text background color (ARGB format, default is semi-transparent black: -2147483648)" +
                    "\n十六进制 | Hexadecimal: 0x80000000")
            .defineInRange("backgroundColor", -2147483648, Integer.MIN_VALUE, Integer.MAX_VALUE);
